...
- Whether you need a separate Terms of Service. Apple requires a privacy policy;
  terms are optional unless you have a subscription auto-renew disclosure need,
  which the paywall already carries in-app.
-->
