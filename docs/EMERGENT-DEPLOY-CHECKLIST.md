...
- ~~**Four art assets** must be regenerated before submission. `otter-focus.png` has an **Apple logo** on the laptop (trademark exposure) and renders as the Room's resting state. See `HANDOFF-TO-EMERGENT.md` section 6.~~ **DONE 2026-07-17 (Emergent).** All four regenerated via Nano Banana with hard style-negatives, flood-filled to real transparency, visually verified in-app. See `HANDOFF-TO-EMERGENT.md` §6 addendum.
...
- **Age rating** questionnaire, answered honestly (AI-generated content + mental-health themes, lands at 12+ or 17+). Draft answers in `docs/2026-07-17-app-store-copy.md` §7.
- App Store Connect contact info, and the manual-release toggle.
- **App Store display name** — global-unique check may bump `Otterly`. Fernando is picking one during the App Store Connect wizard (2026-07-17). Options in `docs/2026-07-17-app-store-copy.md` §1.
- **App Store submission copy** — draft ready at `docs/2026-07-17-app-store-copy.md`. Description, keywords, promo text, keywords, age-rating rationale, review notes template, screenshot captions.
